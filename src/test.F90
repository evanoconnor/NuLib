...
program test
  ...
  do i=1,nnuc
     write(11,"(A14,A3,I2,A3,I2,A3,I3,A3,F8.4)")"pos. daughter","z=",int(nuclear_species(i,3))-1,"n=",int(nuclear_species(i,2))-(int(nuclear_species(i,3)-1)),"a=",int(nuclear_species(i,2)),"Q=",nuclear_species(i,1)
     do j=2,25
        do k=1,25
           query_t9 = t9array(k)
           query_lrYe = dble(j)/2
           write(11,"(F7.2,F6.1,F8.3,F10.3,F10.3,F10.3,F9.3,F9.3,F9.3)") query_t9,query_lrYe,&
                0.0000d0,&
