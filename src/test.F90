...
!###########################
  ...
  open(11,file="analysis/qvnurates.dat")
  open(22,file="analysis/qvnurates_analytic.dat")
  ...
  rate=0.0d0
  do i=-200,200
     write(22,*) dble(i)/10.0d0, analytic_weakrates(0,(t9arr(1)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(1,1)), analytic_weakrates(0,(t9arr(1)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(1,2)), analytic_weakrates(0,(t9arr(1)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(1,3)), analytic_weakrates(0,(t9arr(1)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(1,4))&
          , analytic_weakrates(0,(t9arr(2)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(2,1)), analytic_weakrates(0,(t9arr(2)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(2,2)), analytic_weakrates(0,(t9arr(2)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(2,3)), analytic_weakrates(0,(t9arr(2)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(2,4))&
          , analytic_weakrates(0,(t9arr(3)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(3,1)), analytic_weakrates(0,(t9arr(3)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(3,2)), analytic_weakrates(0,(t9arr(3)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(3,3)), analytic_weakrates(0,(t9arr(3)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(3,4))&
          , analytic_weakrates(0,(t9arr(4)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(4,1)), analytic_weakrates(0,(t9arr(4)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(4,2)), analytic_weakrates(0,(t9arr(4)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(4,3)), analytic_weakrates(0,(t9arr(4)*10**9)*kelvin_to_mev,dble(i)/10.0d0,muearr(4,4))
  end do
