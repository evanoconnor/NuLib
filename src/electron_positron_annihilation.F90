...
function epannhil_Phi0_BRT06(nu_energy_x,nubar_energy_x,matter_eta,neutrino_species) result(Phi)
  ...
  !inputs
  real*8, intent(in) :: nu_energy_x !nueutrino energy/Temp
...
function epannhil_H0_BRT06(nu_energy,nubar_energy,electron_energy,neutrino_species) result(H0)
  ...
  !inputs
  real*8, intent(in) :: nu_energy !neutrino energy, MeV
  real*8, intent(in) :: nubar_energy !antineutrino energy, MeV
  real*8, intent(in) :: electron_energy !electron energy, MeV
